...
?>
			...
			with very little past web development experience. When I started, I had a basic
			...
			and I can't really recommend Team Treehouse over any of them. Team Treehouse is just what I 
			went with, so take that for what it is. Using their "learning tracks", I've learned 
			all the web development skills I have (HTML, CSS, PHP), and some more. I'm still using their
			website at the time of this post to get a deeper understanding of MySQL in order to later develop the
			backend of this website.</p>
			...
			when something didn't work how I expected it to.</p>
			...
			the deployments for the site once the website does launch, but we'll see how that pans out in the future. It feels like 
			...
			<p>On the website (as of now), each page has a scrollbar. Each page will have a scrollbar regardless
			...
			dedicated to contacting me. That page has since been merged into the Resume page, but when it existed,
			...
			<p>This was a problem that puzzled me for a long time. I spent at least a couple of hours staring at the CSS 
			for the website, wondering what could be causing such a strange issue. I was convinced that there was an issue with
			the margins or padding on the navigation elements at the top of the page, but couldn't figure out what it was.
			...
			<p>He didn't even look at the code. He just sees the issue I'm describing and goes, "It's the scrollbars."</p>

			<p>As it turns out, the scrollbars on the side of a webpage can, and will, move your content to make room for their
			existence. I'm not even sure if I would have came to that conclusion without help. I haven't found what I 
			consider to be an elegant solution to that problem. I'm positive there's one out there, and I'm sure it's simple
			to implement. But I was so tired of staring at such a glaring issue, that I decided...</p>
