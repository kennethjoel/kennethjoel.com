...
?>
			...
			<div class="skills-wrap">
				...
				<div class="skill"><span class="symbol">&hearts;</span> HTML</div>
				<div class="skill"><span class="symbol">&hearts;</span> CSS</div>
				<div class="skill"><span class="symbol">&hearts;</span> Git</div>
			</div>
			...
			<div class="first-col">
				...
				<h3>Byron P. Steele II High School</h3>
